  ...
  return (
    ...
    >
      ...
      <div
        style={{
          textAlign: 'center',
          border: state === 'running' ? '2px solid #fff' : '2px solid #444',
          padding: '2rem 3rem',
          background: state === 'done' ? '#fff' : '#000',
        }}
      >
        <div
          style={{
        ...
        <div
          className="label"
          style={{ marginTop: '0.5rem', color: state === 'done' ? '#444' : '#888' }}
        >
          {state === 'idle'
